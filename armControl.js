...
function drawVehicle(){
    ...
    ctx.beginPath();
    ctx.rect(bodyBase.x, bodyBase.y, bodyBase.width, bodyBase.height);
    ctx.fillStyle = "#FFFFFF";
    ctx.fill();
    ctx.stroke();

    ctx.beginPath();
    ctx.rect(bodyBase.x - bodyBase.width / 2, bodyBase.y, bodyBase.width / 2, bodyBase.height);
    ctx.fillStyle = "#000000";
    ctx.fill();
    ctx.stroke();

    ctx.beginPath();
    ctx.rect(bodyBase.x + bodyBase.width, bodyBase.y, bodyBase.width / 2, bodyBase.height);
    ctx.fillStyle = "#000000";
    ctx.fill();
    ctx.stroke();
}
...
armControl.addEventListener("mousemove", function (event) {
    if (click && armBase.x - maxLength < event.offsetX &&
        ...
        document.getElementById("base-value").innerHTML = -base * 180 / Math.PI;
        ...
        document.getElementById("pince-value").innerHTML = pince * 180 / Math.PI;
        ...
        if (rotation > 0 && rotation < Math.PI) {
            ...
            document.getElementById("rotation-value").innerHTML = rotation * 180 / Math.PI;
...
function calculateAndDraw(stabilisation) {
    ...
    if (0 > joint1 && joint1 > -Math.PI &&
        ...
        document.getElementById("joint1-value").innerHTML = - joint1 * 180 / Math.PI;
        document.getElementById("joint2-value").innerHTML = joint2 * 180 / Math.PI;// + 90;// enlever + 90 si 0-180 PAS perpendiculare 
        document.getElementById("joint3-value").innerHTML = joint3 * 180 / Math.PI + 90; // enlever + 90 si 0-180 PAS perpendiculare 
        document.getElementById("stabilisation-value").innerHTML = stabilisation * 180 / Math.PI;
